...
def teacher_classes_view(request):
    ...
    return render(request, 'home/teacher/teacher_classes.html',
                  {'classes': classes, 'pending_requests': pending_requests})
...
def teacher_specific_class_view(request, class_name):
    ...
    return render(request, 'home/teacher/teacher_specific_class.html', {'class' : cur_class, 'enrolled_students' : enrolled_students, 'uploaded_documents' : uploaded_documents})
...
def teacher_adds_document_view(request, class_name):
    ...
    return render(request, 'home/teacher/teacher_adds_document.html', {'form' : form, 'class_name' : class_name})
